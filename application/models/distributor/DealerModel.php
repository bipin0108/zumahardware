...
class DealerModel extends CI_Model
{
	...
	{	
		...
		$sql = "SELECT * FROM users WHERE type='dealer' AND distributor_id = '".$distributor_id."' ORDER BY user_id DESC";
	...
	public function add_dealer($params)
	{  
 	...
 	public function get_dealer_by_id($user_id) 
	{  
 		$this->db->select('*');
	...
	public function update_dealer_by_id($user_id,$params)
	{
	...
	{  
 	...
 	public function dealer_transfer_history_by_id($user_id)
   	{

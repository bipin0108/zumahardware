<?php 
$obj=&get_instance();
$offer=$obj->offermodel->get_offer_by_carpenter();
?> 
<link rel="stylesheet" href="<?=base_url('public');?>/components/datatables.net-bs/css/dataTables.bootstrap.min.css">
  <div class="content-wrapper">
    <!-- Content Header (Page header) -->
    <section class="content-header">
      <h1>Carpenter Offers</h1>
    </section>
    <!-- Main content -->
        ...
        <div class="col-xs-12">
           <div class="box box-primary">
            <div class="box-header">
              ...
              <?php endif ?>
              <span><a href="<?php echo base_url('admin/create-carpenter-offer'); ?>" class="btn btn-primary pull-right">Add Carpenter Offer</a></span>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <table id="offer_table" class="table table-bordered table-striped">
                ...
                <?php foreach($offer as $row) { ?>
                  <tr>
                    ...
                    <td>
                      <img src="<?php echo UPLOAD_PATH."offer/carpenter_offer/".$row->image; ?>" style="height: 40px;width: 40px;border-radius:40px; ">
                    </td>
                    <td style="display: inline-flex;">
                      <a class="btn btn-sm btn-info margin-5" href="<?php echo base_url('admin/edit-carpenter-offer/'.$row->id); ?>"><i class="fa fa-edit"></i></a>
...
<div class="modal fade in" id="modalDel">
  <div class="modal-dialog" >
    <div class="modal-content">
      ...
      <form method="post" action="<?php echo base_url('admin/trash-carpenter-offer'); ?>" id="frmDel">

    ...
    <h1>
      Offer
       <div class="pull-right">
        <a href="<?=base_url('admin/dealer-offer-list')?>" class="btn m-b-xs btn-sm btn-info btn-addon"><i class="fa fa-backward"></i> Back</a>
      </div>
    </h1>
  </section>
    ...
    <div class="row">
      <div class="col-md-12">
        <div class="box box-primary">
          ...
          <?php endif ?>
          <form method="post" enctype="multipart/form-data" action="<?= base_url('admin/add-dealer-offer') ?>">
            <div class="box-body">
              <div class="col-md-6">

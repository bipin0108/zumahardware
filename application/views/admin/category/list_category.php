<?php 
$obj=&get_instance();
$category=$obj->categorymodel->get_all_category();
?> 
        ...
        <div class="col-xs-12">
           <div class="box box-primary">
            <div class="box-header">
              ...
              <?php endif ?>
              <span><a href="<?php echo base_url('admin/create-category/'); ?>" class="btn btn-primary pull-right">Add Category</a></span>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <table id="category_table" class="table table-bordered table-striped">
                ...
                <?php foreach($category as $row) { ?>
                  <tr>
                    ...
                    <td>
                      <img src="<?php echo UPLOAD_PATH."categories/".$row->image; ?>" style="height: 40px;width: 40px;border-radius:40px; ">
                    </td>
                    <td style="display: inline-flex;">
                      <a class="btn btn-sm btn-info margin-5" href="<?php echo base_url('admin/edit-category/'.$row->id); ?>"><i class="fa fa-edit"></i></a>
                      <button data-i="<?php echo $row->id; ?>" class="btn btn-sm btn-danger delete margin-5">
                        <i class="fa fa-trash"></i></button>
                      <a class="btn btn-sm btn-primary " href="<?php echo base_url('admin/subcategory-list/'.$row->id); ?>">Subcategory List</a>
                    </td>
                 </tr>                  
                <?php } ?>    
                <?php } ?>

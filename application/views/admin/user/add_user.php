    ...
    <div class="row">
      <div class="col-xs-6">
        <div class="box box-primary">
          ...
          <?php endif ?>
          <!-- START add shop form -->
          <?php echo form_open_multipart('admin/add-user'); ?>
            <div class="box-body">
                ...
                <div class="form-group">
                    ...
                    <input type="password" name="password" value="<?php echo set_value('password')?>" class="form-control" placeholder="Password" autocomplete="off">
                ...
                <div class="form-group">
                    <label>Address</label>
                    <textarea name="address" class="form-control" autocomplete="off" ><?php echo set_value('address')?></textarea>
                ...
                <div class="form-group">
                    <label>Type</label>
                    <input type="text" name="salesman" value="salesman" class="form-control" placeholder="Salesman" autocomplete="off" disabled>
                </div>
                <div class="form-group">

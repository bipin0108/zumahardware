    ...
    <section class="content">
        <div class="col-xs-12">
          <div class="box box-primary">
            <!-- /.box-header -->
            <div class="box-body">
              <form  method="post" action="<?php echo base_url('admin/order-report'); ?>">
                <div class="row">
                  <div class="col-sm-3">
                      <div class="form-group">
                          <label class="required" for="from">Select User</label>
                            <select name="user_type" class="form-control" id="user_type" >
                              ...
                              Dealer</option>
                              <option value="distributor" <?php echo (set_value('user_type')=='distributor')?'selected':'' ?> >
                              Distributor</option>
                  ...
                  <div class="col-sm-3">
                      <div class="form-group">
                          <label class="required">Select Name</label>
                            <select name="dealer_distributor" id="dealer_distributor" class="form-control">
                             
                            </select>
                            <?php echo form_error('dealer_distributor'); ?>
                      </div>
                  </div>
                   <div class="col-sm-3">
                      <div class="form-group">
...
<script type="text/javascript">
  ...
  var user_type = '<?php echo set_value('user_type'); ?>';
   var dealer_distributor = '<?php echo set_value('dealer_distributor'); ?>';
    if(user_type != '')
    {
      $.ajax({
        url:"<?php echo base_url(); ?>admin/user_type_dropdown_ajax",
        method:"POST",
        data:{user_type:user_type,dealer_distributor:dealer_distributor},
        success:function(data)
        {
          $('#dealer_distributor').html(data);
        }
      });
    }   

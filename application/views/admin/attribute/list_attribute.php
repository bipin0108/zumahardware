        ...
        <div class="col-xs-12">
           <div class="box box-primary">
            <div class="box-header">
              ...
              <?php endif ?>
              <span><a href="<?php echo base_url('admin/create-attribute/'); ?>" class="btn btn-sm btn-primary pull-right">Add Attribute</a></span>
            ...
            <div class="box-body">
              <table id="attribute_table" class="table table-bordered table-striped">
                ...
                <tbody>
                <?php if(isset($attribute)){ $cnt=1; ?>  
                <?php foreach($attribute as $row) { ?>
                  <tr>
                    <td><?php echo $cnt++; ?></td>
                    <td><?php echo $row->att_name; ?></td>
                    <td style="display: inline-flex;">
                      <a class="btn btn-sm btn-info margin-5" href="<?php echo base_url('admin/edit-attribute/'.$row->att_id); ?>"><i class="fa fa-edit"></i></a>
                    </td>
                  </tr>                  
                <?php } ?>    
                <?php } ?>
...
<div class="modal fade in" id="modalDel">
  <div class="modal-dialog" >
    <div class="modal-content">
      ...
      <form method="post" action="<?php echo base_url('admin/trash-attribute'); ?>" id="frmDel">

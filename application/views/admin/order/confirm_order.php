...
<?php 
$obj=&get_instance();
$order=$obj->ordermodel->confirm_order_list(); 
?> 
          ...
          <div class="modal-body">
            ...
            <div class="form-group" id="start_date_div" >
                <label>Delivered By</label>
                  <input type="text" name="delivered" class="form-control" value="" id="delivered" autocomplete="off" required>
                <label>LR Number</label>
                  <input type="text" name="lr" class="form-control" value="" id="lr" autocomplete="off" required>
                <label>Date</label>
                  <input autocomplete="off" class="form-control date-picker" name="date" id="date" type="text" value="<?php echo set_value('e_date'); ?>" required>
            </div>
           </div>
...
<script type="text/javascript">
  ...
  $(".change_status").click(function(e){
    ...
    url = "<?php echo base_url();?>admin/change-status/"+order_id;
  ...
  $(document).on('click', '#save', function(){
    ...
    var date = $('#date').val();
    var order_status = $(this).data('orderstatus');
    var payment_status = $(this).data('paymentstatus');
    $.ajax({
      url:"<?php echo base_url(); ?>admin/change-status/"+order_id,
      method:"POST",
      data:{'delivered':delivered,'lr':lr,'date':date,'order_status':order_status},

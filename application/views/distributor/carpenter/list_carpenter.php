<?php 
  $obj=&get_instance();
  $user=$obj->carpentermodel->get_all_carpenter(); 
?> 
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 ">
           <div class="box">
            <div class="box-header">
              ...
              <a href="<?php echo base_url('distributor/create-carpenter'); ?>" class="btn btn-primary pull-right" >Add Carpenter</a>
                    ...
                    <td>
                      <img src="<?php echo UPLOAD_PATH."user/".$row->image; ?>" style="height: 35px;width: 35px;border-radius:40px; "> <?php echo $row->first_name." ".$row->last_name; ?>
                        ...
                        <td style="display: inline-flex;">
                          <a class="btn btn-warning margin-5" href="<?php echo base_url('distributor/edit-carpenter?user_id='.$row->user_id); ?>">
                            <i class="fa fa-edit"></i>
                          </a>
                          <button data-i="<?php echo $row->user_id; ?>" class="btn btn-danger delete margin-5">
                            <i class="fa fa-trash"></i>
                          </button>
                          <a class="btn btn-sm btn-primary margin-5" href="<?php echo base_url('distributor/carpenter-translation-history/'.$row->user_id); ?>">
                            <i class="fa fa-eye"></i>
                          </a>
                        </td>
                  </tr>                  
...
<div class="modal fade in" id="modalDel">
  <div class="modal-dialog" >
    <div class="modal-content">
      ...
      <form method="post" action="<?php echo base_url('distributor/trash-carpenter'); ?>" id="frmDel">

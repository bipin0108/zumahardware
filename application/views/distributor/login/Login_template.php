...
<div class="login-box">
  <div class="login-logo">
    <a href="<?php echo base_url('distributor/login/'); ?>"><img src="<?php echo base_url('public/images/logo.png'); ?>" style="width: 160px;"></a>
  </div>
  ...
  <div class="login-box-body">
    ...
    <form method="post" action="<?php echo base_url('distributor/authlogincheck') ?>">
      ...
      <div class="row">
        <div class="col-xs-8">
          <a href="<?=base_url('distributor/i-forgot-my-password');?>">I forgot my password</a>
        </div>
        <div class="col-xs-4">

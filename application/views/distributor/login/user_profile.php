      ...
      <div class="row">
        <div class="col-md-3" >
          ...
          <div class="box box-primary" id="element_overlap">
            ...
            ?>
              <img class="profile-user-img img-responsive img-circle profileImgUrl"  style="height: 100px;" src="<?php echo base_url('uploads/distributor/'.$user['image']); ?>" alt="<?=$user['id'];?>">
          ...
          <div class="nav-tabs-custom" id="element_overlap1">
            <ul class="nav nav-tabs">
              <li class="active"><a href="#activity" data-toggle="tab">General Details</a></li>
               ...
               <li><a href="#points" data-toggle="tab">Transfer Points</a></li>
            </ul>
            <div class="tab-content">
              ...
              <div class="tab-pane" id="profileimage">
                <?php if(!empty($this->session->flashdata('img_success'))): ?>
                  ...
                  <?php endif ?>
                  <form role="form" class="form-horizontal" enctype="multipart/form-data" method="post" action="<?php  echo base_url('distributor/upload-profile'); ?>">
                    ...
                    <div class="row">
                      <div class="col-sm-offset-2 col-sm-10">
                          <?php 
                            ...
                            {
                              $img_src = base_url('uploads/distributor/').$p_img;
                            }
                            else
                            {
                        ...
                        <div class="form-group">
                         ...
                         <div class="form-group">
                            <div class="col-sm-offset-2 col-sm-10">
                              ...
                              <a href="<?php echo base_url('distributor/profile'); ?>" type=button class="btn btn-sm btn-default">Cancel</a>
                            </div>  
                          </div>
                      </div>
                    </div>
              ...
              <div class="active tab-pane" id="activity">
                ...
                <form role="form" class="form-horizontal" method="post" action="<?php  echo base_url('distributor/profile-details-update'); ?>">
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    <label for="" class="col-sm-2 control-label">Name</label>
                     <div class="col-sm-5">
                      <input type="text" class="form-control" name="first_name" value="<?=$user['first_name']?>" placeholder="First Name" autocomplete="off">
                      <?php echo form_error('first_name'); ?>
                    </div>
                    
                    <div class="col-sm-5">
                      <input type="text" class="form-control" name="last_name" value="<?=$user['last_name']?>" placeholder="Last Name" autocomplete="off">
                  ...
                  <div class="form-group">
                    <label for="inputEmail" class="col-sm-2 control-label">Email</label>
                     <div class="col-sm-10">
                      <input type="email" class="form-control" name="email" value="<?=$user['email']?>" placeholder="Email" autocomplete="off">
                  ...
                  <div class="form-group">
                    <label  class="col-sm-2 control-label">Mobile No.</label>
                     <div class="col-sm-10">
                      <input type="number" class="form-control" name="mobile_no" value="<?=$user['mobile_no']?>" placeholder="Mobile No." autocomplete="off">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <textarea class="form-control" name="address" placeholder="Address" autocomplete="off"><?=$user['address']?></textarea>
                  ...
                  <div class="form-group">
                    <label class="col-sm-2 control-label">Aadhar No</label>
                     <div class="col-sm-10">
                      <input type="text" class="form-control" name="aadhar_no" value="<?=$user['aadhar_no']?>" placeholder="aadhar_no" autocomplete="off">
              ...
              <div class="tab-pane" id="pwd">
                ...
                <?php endif ?>
                <form role="form" class="form-horizontal" method="post" action="<?php  echo base_url('distributor/update-password'); ?>">
                    <input type="hidden" name="id" value="<?php echo $user['id']; ?>">
                    <div class="form-group">
              ...
              <div class="tab-pane" id="points">
                <?php if(!empty($this->session->flashdata('point_success'))): ?>
                <div class="alert alert-success">
                    <button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
                    <span> <?php echo $this->session->flashdata('point_success'); ?> </span>
                </div>
                <?php endif ?>
                <?php if($this->session->flashdata('point_error')): ?>
                <div class="alert alert-danger">
                    <button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
                    <span><?php echo $this->session->flashdata('point_error') ?></span>
                </div>
                <?php endif ?>
                <form role="form" class="form-horizontal" method="post" action="<?php  echo base_url('distributor/transfer-points'); ?>">
                   <input type="hidden" name="id" value="<?php echo $user['id']; ?>">
                    <div class="form-group">
                        <label class="col-sm-2 control-label">Points</label>
                        <div class="col-sm-4">
                          <input name="points" type="number" class="form-control" placeholder="Points" autocomplete="off">

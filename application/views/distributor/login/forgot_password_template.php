  ...
  <body class="hold-transition login-page">
    <div class="login-box">
      <div class="login-logo">
        <a href="<?php echo base_url('distributor/login/'); ?>"><img src="<?php echo base_url('public/images/logo.jpg'); ?>" style="width: 160px;"></a>
      </div>
      ...
      <div class="login-box-body">
        ...
        <form action="<?=base_url('distributor/i-forgot-my-password');?>" method="post" class="UpdateDetails" id="element_overlap">
          <div class="form-group has-feedback">
           <input type="text" name="email" class="form-control" id="email" placeholder="Email" value="<?php echo set_value('email'); ?>" autocomplete="off">
          ...
          <div class="row">
            <div class="col-xs-6">
              <a href="<?=base_url('distributor/login');?>">Back to login</a><br>
            </div>
            <!-- /.col -->
            <div class="col-xs-6">

    ...
    <div class="row">
      <div class="col-xs-6">
        <div class="box box-primary">
          ...
          <?php endif ?>
          <!-- START add shop form -->
          <?php echo form_open_multipart('distributor/update-dealer'); 
            ...
            <div class="box-body">
              <input type="hidden" name="distributor_id" value="<?php echo $distributor_id; ?>">
                ...
                <div class="form-group">
                    ...
                    <input type="number" name="mobile_no" value="<?php echo $user['mobile_no'] ?>" class="form-control" placeholder="Mobile Number" autocomplete="off"><?php echo form_error('mobile_no'); ?>
                </div>
                <div class="form-group">
                    <label>Address</label>
                ...
                <div class="form-group">
                    ...
                    <input type="number" name="aadhar_no" value="<?php echo $user['aadhar_no'] ?>" class="form-control" placeholder="Aadhar Number" autocomplete="off"><?php echo form_error('aadhar_no'); ?>
                </div>
                <div class="form-group">

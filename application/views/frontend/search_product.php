...
$products = $obj->productmodel->get_all_product();
?>
 <!-- Breadcrumb Start -->
<style type="text/css">
  .pro-img{
                            ...
                            <div class="row">
                                <?php if(!empty($product)){ ?>
                                    <?php foreach ($product as $pro) { 
                                        $cat=$this->homemodel->get_category_by_id($pro->category);
                                        $subcat=$this->homemodel->get_subcategory_by_id($pro->subcategory);
                                        ?>
                                    ...
                                    <div class="col-lg-4 col-sm-6">
                                        <div class="single-product">
                                            <!-- Product Image Start -->
                                            <div class="pro-img">
                                                <a href="<?php echo base_url('zuma-product/'.$cat['slug'].'/'.$subcat->slug.'/'.$pro->slug) ?>">
                                            ...
                                            <div class="pro-content">
                                                <h4>
                                                    ...
                                                    <br>
                                                    <a href="<?php echo base_url('zuma-product/'.$cat_name.'/'.$subcat_name.'/'.$pro->slug) ?>"><?php echo $pro->name; ?></a>
                                                </h4>
